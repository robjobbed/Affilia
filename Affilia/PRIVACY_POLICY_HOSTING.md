...
6. **Your URLs will be:**
   ```
   https://YOUR_USERNAME.github.io/affilia-legal/privacy.html
   https://YOUR_USERNAME.github.io/affilia-legal/terms.html
   ```

7. **Update Config.swift**
   ```swift
   static let privacyPolicyURL = "https://YOUR_USERNAME.github.io/affilia-legal/privacy.html"
   static let termsOfServiceURL = "https://YOUR_USERNAME.github.io/affilia-legal/terms.html"
   ```
...
5. **Your URLs:**
   ```
   https://affilia-legal.vercel.app/privacy.html
   https://affilia-legal.vercel.app/terms.html
   ```
...
<head>
    ...
    <title>Privacy Policy - Affilia</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>At Affilia, we are committed to protecting your privacy and ensuring transparency about how we collect, use, and safeguard your personal information. This Privacy Policy explains our practices regarding your data when you use our platform.</p>

        <h2>1. Information We Collect</h2>
        
        <h3>1.1 Information You Provide</h3>
        <p>When you create an account or use Affilia, you may provide:</p>
        <ul>
        ...
        <p>We automatically collect certain information when you use Affilia:</p>
        <ul>
        ...
        <ul>
            <li>Provide, maintain, and improve Affilia services</li>
        ...
        <ul>
            ...
            <li>To protect rights, property, or safety of Affilia or users</li>
        ...
        <p>Affilia is not intended for users under the age of 18. We do not knowingly collect information from children. If we learn that we have collected information from a child under 18, we will delete it promptly.</p>
        ...
        <div class="contact">
            ...
            <p><strong>Email:</strong> <a href="mailto:rob@affilia.io">rob@affilia.io</a></p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Terms of Service - Affilia</title>
    <style>
        body {
            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, sans-serif;
            line-height: 1.6;
...
<body>
    <div class="container">
        ...
        <h2>Welcome to Affilia</h2>
        <p>These Terms of Service ("Terms") govern your access to and use of Affilia, a platform connecting independent developers and designers with clients seeking their services. By accessing or using Affilia, you agree to be bound by these Terms.</p>
...
<body>
    <div class="container">
        ...
        <p style="margin-top: 60px; font-size: 0.9em;">
            Contact: <a href="mailto:rob@affilia.io" style="background: none; padding: 0; color: #9BAA7F;">rob@affilia.io</a>
        </p>
    </div>
</body>
</html>
