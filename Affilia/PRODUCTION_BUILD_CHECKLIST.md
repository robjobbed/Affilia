...
static let apiBaseURL: String = {
    if isProduction {
        return "https://api.affilia.io"  // ✅ Your production URL
    } else {
...
<string>com.affilia.app</string>  <!-- Your bundle ID -->
```
...
static let privacyPolicyURL = "https://affilia.io/privacy"  // ✅ Must be live
```

**Test URL before submission:**
```bash
curl -I https://affilia.io/privacy
...
✅ Privacy Policy URL live: https://affilia.io/privacy
✅ Terms of Service URL live: https://affilia.io/terms
✅ Debug prints removed/disabled
✅ OAuth credentials verified (X & GitHub)
✅ Bundle identifier correct: com.affilia.app
✅ Version/Build numbers incremented
...
✅ Keywords added
✅ Support email verified: rob@affilia.io
