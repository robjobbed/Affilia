...
- [x] Contact Support (rob@affilia.io) implemented
- [x] All legal docs dated February 4, 2026

### 2. 🔐 App Store Connect Setup

#### App Information
- [ ] **App Name**: "Affilia" (check availability)
- [ ] **Subtitle**: "Connect with Indie Developers" (35 char max)
- [ ] **Bundle ID**: `com.affilia.app` or similar
...
- [ ] **Privacy Policy URL**: Upload privacy policy to website first
  - Option 1: `https://affilia.io/privacy`
...
```
Affilia - Where Builders Meet Opportunity

Connect with talented independent developers and designers for your next project. Whether you're hiring or looking for work, Affilia makes it simple.
...
Download Affilia today and start building connections.
```
...
<string>Find your contacts who use Affilia</string>

<!-- Face ID (if implementing) -->
<key>NSFaceIDUsageDescription</key>
<string>Use Face ID to unlock Affilia</string>
```
...
- [ ] **Demo Account**: Create if app requires login
  - Username: `demo@affilia.io` or similar
...
- [ ] **Review Notes**: Explain features
  ...
  Please contact rob@affilia.io with any questions.
  ```

- [ ] **Contact Info**: rob@affilia.io verified
...
4. **Fill App Information**
   ...
   - Support URL (optional): https://affilia.io/support
   - Marketing URL (optional): https://affilia.io
...
- [ ] Post on X (Twitter) with @affiliaapp
...
- **Quick Questions**: rob@affilia.io
