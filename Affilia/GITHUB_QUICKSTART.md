...
Follow these steps to get GitHub OAuth working in your Affilia app in ~10 minutes.
...
3. In Xcode, select your **Affilia** target

4. Go to **Info** tab

5. Scroll to **URL Types** section

6. If "affilia" isn't there, click **+** and add:
...
```
🔄 GitHub callback URL received: affilia://auth/github/callback?code=...
...
- Make sure it's `affilia` (lowercase)
...
- Callback URL in GitHub must be exactly: `affilia://auth/github/callback`
- Check for typos
...
#else
let backendURL = "https://api.affilia.app/api/auth/github/callback"
#endif
```

3. Create production GitHub OAuth app with:
   - Homepage URL: `https://affilia.app`
   - Callback URL: `affilia://auth/github/callback`
