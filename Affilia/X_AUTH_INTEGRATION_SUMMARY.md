...
Your Affilia app now properly integrates with X (Twitter) OAuth to fetch **real user profile data** instead of using hardcoded mock data.
...
When a user signs in with X, their actual username, bio, and follower count will be displayed throughout Affilia.
