# GitHub OAuth Setup Guide for Affilia
...
2. **Fill in Application Details**
   ...
   ```
   Application name: Affilia (Development)
...
let backendURL = "https://api.affilia.app"
#endif
```
...
- [ ] Configured URL Scheme in Xcode (affilia://)
