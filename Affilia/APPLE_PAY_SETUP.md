...
Affilia now includes full Apple Pay integration for hiring freelancers. Clients can securely pay freelancers directly through Apple Pay with a 5% platform fee automatically calculated.
...
3. Use format: `merchant.com.affilia.payments` (or your own)
...
```swift
request.merchantIdentifier = "merchant.com.affilia.payments"
```
