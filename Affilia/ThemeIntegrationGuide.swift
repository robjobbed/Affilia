...
In your main app file (e.g., `AffiliaApp.swift`):
...
// Example code - DO NOT use @main here as it conflicts with the real AffiliaApp.swift
// @main
struct ExampleAffiliaApp: App {
    var body: some Scene {
        WindowGroup {
            ExampleRootView()
