...
## Overview
This guide shows how to integrate the new dual marketplace system into your existing Affilia app.
...
func loadGigs() async {
    ...
    do {
        let url = URL(string: "https://api.affilia.app/gigs")!
...
class GigManager: ObservableObject, WebSocketDelegate {
    ...
    func connectToRealTime() {
        var request = URLRequest(url: URL(string: "wss://api.affilia.app/gigs/live")!)
