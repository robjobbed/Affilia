...
struct Config {
    ...
    static let apiBaseURL: String = {
        if isProduction {
            return "https://api.affilia.io"  // TODO: Replace with your production API
        } else {
    ...
    /// OAuth Redirect URI
    static let oauthRedirectURI = "affilia://auth/x/callback"
    ...
    /// Support email
    static let supportEmail = "rob@affilia.io"
    
    /// Privacy policy URL
    static let privacyPolicyURL = "https://affilia.io/privacy"  // TODO: Host privacy policy
    
    /// Terms of service URL
    static let termsOfServiceURL = "https://affilia.io/terms"  // TODO: Host terms of service
