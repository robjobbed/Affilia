...
I've set up a complete GitHub OAuth implementation for Affilia. Here's everything that's ready:
...
2. Create OAuth App with callback: `affilia://auth/github/callback`
...
User authorizes
    ↓
Redirects back to app: affilia://auth/github/callback?code=abc123
    ↓
iOS extracts code
    ↓
